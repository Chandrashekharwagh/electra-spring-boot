...
public class CustomerController {
    ...
    public String updateCustomerForCustomerId(@PathVariable int customerId, @RequestBody Customer customer , Address address) {
        return customerService.updateCustomer(customerId, customer ,address);
    }
}